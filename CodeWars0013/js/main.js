...
//  or max_load (in Ruby) amount of clothes. You are given a clothes amount of clothes 
// to wash. For each single item of clothes above the load, the washing machine will 
// use 10% more water (multiplicative) to clean.
...
// mount of load (max_load), return 'Too much clothes'. The washing machine also 
// cannot handle any amount of clothes less than load (max_load). If that is the case,
...
function howMuchWater(water, load, clothes) {
    ...
    //toFixed value returns a string, using a Unary operator to convert the 
    // value back to number
